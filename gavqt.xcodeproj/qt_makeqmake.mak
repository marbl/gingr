...
QMAKE    = /usr/bin/qmake
gavqt.xcodeproj/project.pbxproj: gavqt.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o gavqt.xcodeproj/project.pbxproj gavqt.pro
