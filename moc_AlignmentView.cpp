...
static const char qt_meta_stringdata_AlignmentView[] = {
    "AlignmentView\0\0lcb,offset\0"
    "signalLcbHoverChange(int,float)\0"
    "setLcbHover(int,float)\0"
};
...
void AlignmentView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->signalLcbHoverChange((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2]))); break;
        case 1: _t->setLcbHover((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData AlignmentView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject AlignmentView::staticMetaObject = {
    { &TrackListView::staticMetaObject, qt_meta_stringdata_AlignmentView,
      qt_meta_data_AlignmentView, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &AlignmentView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AlignmentView))
